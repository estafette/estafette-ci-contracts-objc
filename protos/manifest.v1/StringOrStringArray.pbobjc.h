 ...
 **/
@interface StringOrStringArrayRoot : GPBRootObject
@end

#pragma mark - StringOrStringArray

typedef GPB_ENUM(StringOrStringArray_FieldNumber) {
  StringOrStringArray_FieldNumber_ValuesArray = 1,
};

@interface StringOrStringArray : GPBMessage
