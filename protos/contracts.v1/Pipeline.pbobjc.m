...
#import "protos/contracts.v1/Pipeline.pbobjc.h"
...
@dynamic hasLastUpdatedAt, lastUpdatedAt;
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        ...
        .number = Pipeline_FieldNumber_InsertedAt,
        .hasIndex = 10,
        .offset = (uint32_t)offsetof(Pipeline__storage_, insertedAt),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "updatedAt",
        .dataTypeSpecific.className = GPBStringifySymbol(GPBTimestamp),
        .number = Pipeline_FieldNumber_UpdatedAt,
        .hasIndex = 11,
        .offset = (uint32_t)offsetof(Pipeline__storage_, updatedAt),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
      {
      ...
      },
      {
        .name = "lastUpdatedAt",
        .dataTypeSpecific.className = GPBStringifySymbol(GPBTimestamp),
        .number = Pipeline_FieldNumber_LastUpdatedAt,
        .hasIndex = 13,
        .offset = (uint32_t)offsetof(Pipeline__storage_, lastUpdatedAt),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
    };
