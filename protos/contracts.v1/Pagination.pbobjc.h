 ...
 **/
@interface PaginationRoot : GPBRootObject
@end
...
typedef GPB_ENUM(Pagination_FieldNumber) {
  ...
  Pagination_FieldNumber_TotalPages = 3,
  Pagination_FieldNumber_TotalItems = 4,
};
...
@property(nonatomic, readwrite) int64_t totalPages;

@property(nonatomic, readwrite) int64_t totalItems;
