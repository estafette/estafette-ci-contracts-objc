 ...
 **/
@interface EstafetteDockerTriggerRoot : GPBRootObject
@end

#pragma mark - EstafetteDockerTrigger

typedef GPB_ENUM(EstafetteDockerTrigger_FieldNumber) {
  EstafetteDockerTrigger_FieldNumber_Event = 1,
  EstafetteDockerTrigger_FieldNumber_Image = 2,
  EstafetteDockerTrigger_FieldNumber_Tag = 3,
};

@interface EstafetteDockerTrigger : GPBMessage
