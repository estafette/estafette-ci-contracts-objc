 ...
 **/
@interface EstafetteReleaseRoot : GPBRootObject
@end

#pragma mark - EstafetteRelease

typedef GPB_ENUM(EstafetteRelease_FieldNumber) {
  EstafetteRelease_FieldNumber_Name = 1,
  EstafetteRelease_FieldNumber_CloneRepository = 2,
  EstafetteRelease_FieldNumber_ActionsArray = 3,
  EstafetteRelease_FieldNumber_TriggersArray = 4,
  EstafetteRelease_FieldNumber_StagesArray = 5,
};

@interface EstafetteRelease : GPBMessage

@property(nonatomic, readwrite, copy, null_resettable) NSString *name;

@property(nonatomic, readwrite) BOOL cloneRepository;
