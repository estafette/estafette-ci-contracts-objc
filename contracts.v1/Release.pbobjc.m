  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        ...
        .number = Release_FieldNumber_InsertedAt,
        .hasIndex = 7,
        .offset = (uint32_t)offsetof(Release__storage_, insertedAt),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "updatedAt",
        .dataTypeSpecific.className = GPBStringifySymbol(GPBTimestamp),
        .number = Release_FieldNumber_UpdatedAt,
        .hasIndex = 8,
        .offset = (uint32_t)offsetof(Release__storage_, updatedAt),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
      {
