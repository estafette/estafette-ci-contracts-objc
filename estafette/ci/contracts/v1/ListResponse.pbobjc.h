 ...
 **/
@interface ListResponseRoot : GPBRootObject
@end

#pragma mark - ListResponse

typedef GPB_ENUM(ListResponse_FieldNumber) {
  ListResponse_FieldNumber_ItemsArray = 1,
  ListResponse_FieldNumber_Pagination = 2,
};

@interface ListResponse : GPBMessage

@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<GPBAny*> *itemsArray;
